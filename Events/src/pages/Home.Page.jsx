        ...
        <div className="w-full relative py-32 md:py-48 flex flex-col items-center overflow-hidden">
           ...
           <div className="container mx-auto px-6 text-center z-10">
              <div className="inline-flex items-center gap-3 px-6 py-2.5 bg-white/5 border border-white/10 rounded-full mb-10 backdrop-blur-md">
                 ...
                 <span className="text-[10px] md:text-sm font-black text-slate-300 tracking-[0.3em] uppercase">Parking Solved for Experience Seekers</span>
              </div>
              
              <div className="flex flex-col items-center">
                 <h1 className="text-7xl md:text-[14rem] font-black uppercase tracking-tighter leading-[0.75] m-0 p-0 text-transparent bg-clip-text bg-gradient-to-b from-white to-white/10 select-none animate-reveal" style={{ animationDelay: '0.1s' }}>
                    DON'T MISS
                 </h1>
                 <h1 className="text-7xl md:text-[14rem] font-black uppercase tracking-tighter leading-[0.75] m-0 p-0 text-transparent bg-clip-text bg-gradient-to-b from-indigo-400 to-indigo-800/20 select-none pb-4 animate-reveal -mt-2 md:-mt-4" style={{ animationDelay: '0.3s' }}>
                    THE VIBE.
                 </h1>
              </div>
